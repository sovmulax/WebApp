var MCK_CONTEXTPATH = 'https://widget.kommunicate.io';
var MCK_STATICPATH = 'https://widget.kommunicate.io/plugin';
var MCK_ONINIT = '';
var KM_PLUGIN_SETTINGS = JSON.parse('{"pseudoNameEnabled":true,"kommunicateApiUrl":"https://api.kommunicate.io","botPlatformApi":"https://bots.kommunicate.io","applozicBaseUrl":"https://chat.kommunicate.io"}');
var MCK_PLUGIN_VERSION = 'v2';
var MCK_THIRD_PARTY_INTEGRATION = JSON.parse('{"sentry":{"dsn":"https://9f71614ef8184d0cab00074555dad9a7@sentry.io/1321911","enabled":false},"aws":{"cdnUrl":"https://cdn.kommunicate.io","bucket":"km-prod-cdn"}}');
...
function createKommunicateIframe() {
    ...
    kommunicateIframe.innerHTML =
        '<a href="https://www.kommunicate.io/"> Kommunicate Live chat </a>';
    var iframeDocument =
...
function addKommunicatePluginToIframe() {
    ...
    imported.src = "https://cdn.kommunicate.io/a43c165/kommunicate.a43c165.min.js";
